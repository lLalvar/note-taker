                ...
                <View className='flex-1 gap-1'>
                  ...
                  <View className='flex-row items-center gap-1'>
                    ...
                    <View
                      ...
                      style={{
                        borderColor: toHsla(previewColors.mutedForeground, 0.5),
                      }}
                    />
                  </View>
                </View>
                ...
                <View className='flex-row items-start gap-1.5'>
                  ...
                  <View className='flex-1 gap-0.5'>
                    <View
                      ...
                      style={{
                        backgroundColor: toHsla(previewColors.foreground, 0.7),
                      }}
                    />
                    <View
                      className='h-0.5 w-full rounded'
                      style={{
                        backgroundColor: toHsla(previewColors.foreground, 0.3),
                      }}
                    />
                  </View>
                  {/* Icon */}
